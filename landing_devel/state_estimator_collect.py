...
label_path = '/home/lucas/Research/VisionLand/Aircraft_Landing/catkin_ws/src/landing_devel/estimation_label'
...
def sample_state_estimator():
    ...
    while not rospy.is_shutdown():
        ...
        # cv2.waitKey(3)
        state_estimation = state_estimator(cv_img)
