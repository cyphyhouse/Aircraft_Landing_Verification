...
from get_all_models_rain_snow import get_all_models
...
def partitionE(E):
    partition_list = []
    E1 = np.arange(E[0,0], E[1,0]+0.001, 0.005)
    E2 = np.arange(E[0,1], E[1,1]+0.001, 0.005)
...
if __name__ == "__main__":
    ...
    with open('exp1_res_safe_rain_snow.pickle', 'wb+') as f:
