from models.model_x2_rain_snow import compute_model_x
from models.model_y2_rain_snow import compute_model_y
from models.model_z2_rain_snow import compute_model_z
from models.model_yaw2_rain_snow import compute_model_yaw
from models.model_pitch2_rain_snow import compute_model_pitch
import os 
import pickle 
import numpy as np
import json 
...
def get_all_models(data):
    ...
    model_x = compute_model_x(state_array, trace_array, E_array, 0.5, 0.93)
    model_y = compute_model_y(state_array, trace_array, E_array, 0.5, 0.93)
    model_z = compute_model_z(state_array, trace_array, E_array, 0.5, 0.93)
    model_yaw = compute_model_yaw(state_array, trace_array, E_array, 0.5, 0.93)
    model_pitch = compute_model_pitch(state_array, trace_array, E_array, 0.5, 0.93)
