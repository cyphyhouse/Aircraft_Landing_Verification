...
if __name__ == "__main__":
    ...
    fn = os.path.join(script_dir, './exp1_res_safe.pickle')
    ...
    with open(os.path.join(script_dir,'vcs_sim_exp1_safe.pickle'),'rb') as f:
        vcs_sim_trajectories = pickle.load(f)
    with open(os.path.join(script_dir,'vcs_estimate_exp1_safe.pickle'), 'rb') as f:
        vcs_sim_estimate = pickle.load(f)
    with open(os.path.join(script_dir,'vcs_init_exp1_safe.pickle'),'rb') as f:
    ...
    with open(os.path.join(script_dir,'vcs_sim_exp1_safecomp.pickle'),'rb') as f:
        vcs_sim_trajectories = pickle.load(f)
    with open(os.path.join(script_dir,'vcs_estimate_exp1_safecomp.pickle'), 'rb') as f:
        vcs_sim_estimate = pickle.load(f)
    with open(os.path.join(script_dir,'vcs_init_exp1_safecomp.pickle'),'rb') as f:
        vcs_sim_init = pickle.load(f)
