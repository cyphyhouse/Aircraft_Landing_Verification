...
if __name__ == "__main__":
    ...
    fn = os.path.join(script_dir, './exp1_res_safe_rain_snow_extend.pickle')
    ...
    with open(os.path.join(script_dir,'vcs_sim_exp1_safe_rain_snow_extend.pickle'),'rb') as f:
        vcs_sim_trajectories = pickle.load(f)
    with open(os.path.join(script_dir,'vcs_estimate_exp1_safe_rain_snow_extend.pickle'), 'rb') as f:
        vcs_sim_estimate = pickle.load(f)
    with open(os.path.join(script_dir,'vcs_init_exp1_safe_rain_snow_extend.pickle'),'rb') as f:
    ...
    with open(os.path.join(script_dir,'vcs_sim_exp1_safecomp_rain_snow_extend.pickle'),'rb') as f:
        vcs_sim_trajectories = pickle.load(f)
    with open(os.path.join(script_dir,'vcs_estimate_exp1_safecomp_rain_snow_extend.pickle'), 'rb') as f:
        vcs_sim_estimate = pickle.load(f)
    with open(os.path.join(script_dir,'vcs_init_exp1_safecomp_rain_snow_extend.pickle'),'rb') as f:
        vcs_sim_init = pickle.load(f)
    ...
    with open(os.path.join(script_dir, '../data_train_exp1_rain_snow_extend.pickle'), 'rb') as f:
        data = pickle.load(f)
    ...
    ax = plt.gca()
    ax.set_xticks(np.round(np.arange(0,32,6)-0.5,1))
    ax.set_yticks(np.round(np.arange(0,22,2)-0.5,1))
    ax.set_xticklabels(np.round(np.arange(0.0, 0.0305, 0.006),5), fontsize=14)
    ax.set_yticklabels(np.round(np.arange(0.0, 1.005, 0.1),2), fontsize=14)
