...
# plt.plot(data_train_0[:,0], label_train_0[:,0], '*', color='tab:blue', label='0.5<=lighting<0.6')
# plt.plot(data_train_1[:,0], label_train_1[:,0], '*', color='tab:orange', label='0.6<=lighting<0.7')
# plt.plot(data_train_2[:,0], label_train_2[:,0], '*', color='tab:green', label='0.7<=lighting<0.8')
# plt.plot(data_train_3[:,0], label_train_3[:,0], '*', color='tab:red', label='0.8<=lighting<0.9')
# plt.plot(data_train_4[:,0], label_train_4[:,0], '*', color='tab:purple', label='0.9<=lighting<1.0')
# plt.plot(data_train_5[:,0], label_train_5[:,0], '*', color='tab:brown', label='1.0<=lighting<1.1')
# plt.plot(data_train_6[:,0], label_train_6[:,0], '*', color='tab:pink', label='1.1<=lighting')
...
# plt.ylabel('Error x')
plt.legend()
plt.savefig('distribution_x-vs-error_x_1.png')

plt.figure()
plt.plot(data_train[:,0], label_train[:,0],'b*', label='Training Set')
# plt.plot(data_test[:,0], label_test[:,0],'r*', label='Testing Set')
# plt.plot(data_train_0[:,1], label_train_0[:,1], '*', color='tab:blue', label='0.5<=lighting<0.6')
# plt.plot(data_train_1[:,1], label_train_1[:,1], '*', color='tab:orange', label='0.6<=lighting<0.7')
# plt.plot(data_train_2[:,1], label_train_2[:,1], '*', color='tab:green', label='0.7<=lighting<0.8')
# plt.plot(data_train_3[:,1], label_train_3[:,1], '*', color='tab:red', label='0.8<=lighting<0.9')
# plt.plot(data_train_4[:,1], label_train_4[:,1], '*', color='tab:purple', label='0.9<=lighting<1.0')
# plt.plot(data_train_5[:,1], label_train_5[:,1], '*', color='tab:brown', label='1.0<=lighting<1.1')
# plt.plot(data_train_6[:,1], label_train_6[:,1], '*', color='tab:pink', label='1.1<=lighting')
...
# plt.ylabel('Error y')
plt.legend()
plt.savefig('distribution_y-vs-error_x_0.png')

plt.figure()
plt.plot(data_train[:,0], label_train[:,0],'b*', label='Training Set')
# plt.plot(data_test[:,0], label_test[:,0],'r*', label='Testing Set')
# plt.plot(data_train_0[:,2], label_train_0[:,2], '*', color='tab:blue', label='0.5<=lighting<0.6')
# plt.plot(data_train_1[:,2], label_train_1[:,2], '*', color='tab:orange', label='0.6<=lighting<0.7')
# plt.plot(data_train_2[:,2], label_train_2[:,2], '*', color='tab:green', label='0.7<=lighting<0.8')
# plt.plot(data_train_3[:,2], label_train_3[:,2], '*', color='tab:red', label='0.8<=lighting<0.9')
# plt.plot(data_train_4[:,2], label_train_4[:,2], '*', color='tab:purple', label='0.9<=lighting<1.0')
# plt.plot(data_train_5[:,2], label_train_5[:,2], '*', color='tab:brown', label='1.0<=lighting<1.1')
# plt.plot(data_train_6[:,2], label_train_6[:,2], '*', color='tab:pink', label='1.1<=lighting')
...
# plt.ylabel('Error z')
plt.legend()
plt.savefig('distribution_z-vs-error_x_0.png')

plt.figure()
plt.plot(data_train[:,0], label_train[:,0],'b*', label='Training Set')
# plt.plot(data_test[:,0], label_test[:,0],'r*', label='Testing Set')
# plt.plot(data_train_0[:,3], label_train_0[:,3], '*', color='tab:blue', label='0.5<=lighting<0.6')
# plt.plot(data_train_1[:,3], label_train_1[:,3], '*', color='tab:orange', label='0.6<=lighting<0.7')
# plt.plot(data_train_2[:,3], label_train_2[:,3], '*', color='tab:green', label='0.7<=lighting<0.8')
# plt.plot(data_train_3[:,3], label_train_3[:,3], '*', color='tab:red', label='0.8<=lighting<0.9')
# plt.plot(data_train_4[:,3], label_train_4[:,3], '*', color='tab:purple', label='0.9<=lighting<1.0')
# plt.plot(data_train_5[:,3], label_train_5[:,3], '*', color='tab:brown', label='1.0<=lighting<1.1')
# plt.plot(data_train_6[:,3], label_train_6[:,3], '*', color='tab:pink', label='1.1<=lighting')
...
plt.legend()
plt.savefig('distribution_roll-vs-error_x_0.png')

plt.figure()
plt.plot(data_train[:,0], label_train[:,0],'b*', label='Training Set')
# plt.plot(data_test[:,0], label_test[:,0],'r*', label='Testing Set')
# plt.plot(data_train_0[:,4], label_train_0[:,4], '*', color='tab:blue', label='0.5<=lighting<0.6')
# plt.plot(data_train_1[:,4], label_train_1[:,4], '*', color='tab:orange', label='0.6<=lighting<0.7')
# plt.plot(data_train_2[:,4], label_train_2[:,4], '*', color='tab:green', label='0.7<=lighting<0.8')
# plt.plot(data_train_3[:,4], label_train_3[:,4], '*', color='tab:red', label='0.8<=lighting<0.9')
# plt.plot(data_train_4[:,4], label_train_4[:,4], '*', color='tab:purple', label='0.9<=lighting<1.0')
# plt.plot(data_train_5[:,4], label_train_5[:,4], '*', color='tab:brown', label='1.0<=lighting<1.1')
# plt.plot(data_train_6[:,4], label_train_6[:,4], '*', color='tab:pink', label='1.1<=lighting')
...
plt.legend()
plt.savefig('distribution_pitch-vs-error_x_0.png')

plt.figure()
plt.plot(data_train[:,0], label_train[:,0],'b*', label='Training Set')
# plt.plot(data_test[:,0], label_test[:,0],'r*', label='Testing Set')
# plt.plot(data_train_0[:,5], label_train_0[:,5], '*', color='tab:blue', label='0.5<=lighting<0.6')
# plt.plot(data_train_1[:,5], label_train_1[:,5], '*', color='tab:orange', label='0.6<=lighting<0.7')
# plt.plot(data_train_2[:,5], label_train_2[:,5], '*', color='tab:green', label='0.7<=lighting<0.8')
# plt.plot(data_train_3[:,5], label_train_3[:,5], '*', color='tab:red', label='0.8<=lighting<0.9')
# plt.plot(data_train_4[:,5], label_train_4[:,5], '*', color='tab:purple', label='0.9<=lighting<1.0')
# plt.plot(data_train_5[:,5], label_train_5[:,5], '*', color='tab:brown', label='1.0<=lighting<1.1')
# plt.plot(data_train_6[:,5], label_train_6[:,5], '*', color='tab:pink', label='1.1<=lighting')
...
plt.legend()
plt.savefig('distribution_yaw-vs-error_x_0.png')
