...
try:
    ...
    sin_yaw_est1 = m.addVar(lb=-float('inf'), vtype=GRB.CONTINUOUS, name='sin_yaw_est1')
    cos_yaw_est1 = m.addVar(lb=-float('inf'), vtype=GRB.CONTINUOUS, name='cos_yaw_est1')
    sin_pitch_est1 = m.addVar(lb=-float('inf'), vtype=GRB.CONTINUOUS, name='sin_pitch_est1')
    cos_pitch_est1 = m.addVar(lb=-float('inf'), vtype=GRB.CONTINUOUS, name='cos_pitch_est1')
    ...
    # Dynamics for step 1
    # 23.339123, 4.873251, 2.01548, 0.001, 0.001, 
    ...
    m.addConstr(x_err1==cos_yaw_est1*(x_ref1-x_est1)+sin_yaw_est1*(y_ref1-y_est1))
    m.addConstr(y_err1==-sin_yaw_est1*(x_ref1-x_est1)+cos_yaw_est1*(y_ref1-y_est1))
    m.addConstr(z_err1==z_ref1-z_est1)
    m.addConstr(yaw_err1==yaw_ref1-yaw_est1)
